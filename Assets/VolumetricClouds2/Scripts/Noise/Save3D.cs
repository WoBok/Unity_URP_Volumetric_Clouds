...
public class Save3D : MonoBehaviour
{
    ...
    public void Save(RenderTexture volumeTexture, string saveName, int resolution)
    {
#if UNITY_EDITOR
        ...
        UnityEditor.AssetDatabase.CreateAsset(x, "Assets/VolumetricClouds/Resources/CloudTextures/" + saveName + ".asset");
#endif
    }
